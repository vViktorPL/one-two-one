...
restLevels = [Screen.Game.Level.Level1.data, Screen.Game.Level.Level2.data, Screen.Game.Level.Level3.data, Screen.Game.Level.Level4.data, Screen.Game.Level.Level5.data, Screen.Game.Level.Level6.data, Screen.Game.Level.Level7.data]