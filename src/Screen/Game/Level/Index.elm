...
import Screen.Game.Level.A_TestLevel
...
firstLevel : Level
firstLevel = Screen.Game.Level.A_TestLevel.data

restLevels : List Level
restLevels = [Screen.Game.Level.Level0.data, Screen.Game.Level.Level1.data, Screen.Game.Level.Level2.data, Screen.Game.Level.Level3.data, Screen.Game.Level.Level4.data, Screen.Game.Level.Level5.data]